...
<table class="table table-striped" border="2">
  ...
  <form action="" method = "get">
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" name="Blogname" placeholder="Your Blog Name..">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        <label for="fname">Blog Description</label>
      </div>
      <div class="col-75">
        <input type="text" name="Blogdescription" placeholder="Your blog Description..">
      </div>
    </div>
    <div class="row">
...
if (isset($_REQUEST['submit'])){
  ...
  $BN = $_REQUEST['Blogname'];
  $BD = $_REQUEST['Blogdescription'];

   

  $sql = mysqli_query($con, "INSERT INTO blogs (blog_name, blog_description) VALUES ('$BN', '$BD')");
  if($sql){
